...
using CbUpdate.Domain.Services;
...
using AuthenticationService = CbUpdate.Domain.Services.AuthenticationService;
using IAuthenticationService = CbUpdate.Domain.Services.Interfaces.IAuthenticationService;
